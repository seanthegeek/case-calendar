...
- **Calendar-client refresh delays.** Subscribed ICS feeds
  ...
  4–16 hours per its own documentation. Direct push to
  [Google Calendar / Microsoft 365](docs/calendars.md) sidesteps
  this lag for the events themselves; the ICS file and the
