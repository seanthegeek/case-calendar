...
- **Static legal disclaimer footer.** Two sentences rendered by the page
  template, not the LLM — "Case descriptions and calendar entries are generated
  by AI from public court filings and may contain mistakes" plus the presumption
  of innocence for criminal defendants.
