...
The index page renders a static `<footer>` block; two of its lines are
legally-sensitive disclaimers kept out of the LLM's output:

> *Case descriptions and calendar entries are generated by AI from public
> court filings and may contain mistakes — consult the linked dockets for
